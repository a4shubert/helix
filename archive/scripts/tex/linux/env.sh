...
export HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE="${HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE:-position.pl.compute}"
export HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE="${HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE:-portfolio.pl.compute}"
export HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE="${HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE:-portfolio.risk.compute}"
...
echo "[env] HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE=${HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE}"
echo "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE=${HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE}"
echo "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE=${HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE}"
