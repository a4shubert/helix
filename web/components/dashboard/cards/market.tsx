...
import type { MarketDataRow } from "@/lib/types/dashboard";

const PAGE_SIZE = 20;

const columnDefs: ColDef<MarketDataRow>[] = [
  { field: "instrument_id", headerName: "Instrument ID", minWidth: 150 },
  ...
  },
  {
    ...
    filterValueGetter: (params) =>
      formatUkDateTime((params.data as MarketDataRow | undefined)?.updated_at),
  },
];
...
const defaultColDef: ColDef<MarketDataRow> = {
  ...
  resizable: true,
  valueFormatter: (params) => {
    if (params.column.getColId() === "updated_at" && typeof params.value === "string") {
...
const helpItems = [
  ...
  "Pagination buttons move through the filtered market data page by page.",
];
