...
export HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE="${HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE:-portfolio.compute}"
...
echo "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE=${HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE}"
