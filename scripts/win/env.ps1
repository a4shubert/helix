...
if (-not $Env:HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE -or [string]::IsNullOrWhiteSpace($Env:HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE)) {
    $Env:HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE = "position.pl.compute"
}
if (-not $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE -or [string]::IsNullOrWhiteSpace($Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE)) {
    $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE = "portfolio.pl.compute"
}
if (-not $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE -or [string]::IsNullOrWhiteSpace($Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE)) {
    $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE = "portfolio.risk.compute"
}
...
Write-Host "[env] HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE=$Env:HELIX_RABBITMQ_QUEUE_POSITION_PL_COMPUTE"
Write-Host "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE=$Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_PL_COMPUTE"
Write-Host "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE=$Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_RISK_COMPUTE"
