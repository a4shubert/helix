...
if (-not $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE -or [string]::IsNullOrWhiteSpace($Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE)) {
    $Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE = "portfolio.compute"
}
...
Write-Host "[env] HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE=$Env:HELIX_RABBITMQ_QUEUE_PORTFOLIO_COMPUTE"
